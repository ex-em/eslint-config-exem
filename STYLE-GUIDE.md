...
조건/반복문/제어문에 중괄호 사용한다. 조건/반복문/제어문이 한줄로 끝이라도 중괄호를 활용한다. eslint: [`curly`](https://eslint.org/docs/rules/curly)
...
- [20.2](#commas--dangling) 끝의 쉼표: **좋아요.** (함수 파라미터 제외) eslint: [`comma-dangle`](https://eslint.org/docs/rules/comma-dangle.html)
...
- [Airbnb 스타일 가이드(영어)](https://github.com/airbnb/javascript)
- [Airbnb 스타일 가이드(한글)](https://github.com/parksb/javascript-style-guide)
